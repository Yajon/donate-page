...
var GithubLink  =   "https://guoyanjun.top/donate-page/";
var PayPalLink  =   "https://www.paypal.me/GuoYanjun";
$('#paypal-donate>a').href = PayPalLink;
$('#github-box>a').href = GithubLink;
var qrcodes = {
    'btc_donate'	:	'../sample1/images/BTCQR.png',	// 二维码路径
    'alipay_donate'	:	'../sample1/images/AliPayQR.png',	// 支付宝二维码
    'alipay_donate_link'   :   'https://www.paypal.me/GuoYanjun',   // 支付宝二维码上的链接，必须换成自己的连接！！！手机点击会自动跳转到支付宝。
    'wechat_donate'	:	'../sample1/images/WeChanQR.png'
};
